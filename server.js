...
<body onload="Prompt()">
	...
	<script>	
		...
		document.getElementById("start_date").addEventListener("change", function(){
			$.get(crime_api_url_global  + '/incidents?start_date='+ document.getElementById("start_date").value +'&end_date=' + document.getElementById("end_date").value, function(data){
				app.incidents = data;
